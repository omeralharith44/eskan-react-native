      ...
      <SafeAreaView style={styles.container} forceInset={{ top: "always" }}>
        <KeyboardView style={styles.content}>
          <ScrollView contentContainerStyle={styles.contentContainerStyle}>
            <Text style={styles.titleText}>{getString("REGISTER_UPPER")}</Text>
            <CheckBox
              text={getString("Is Agent")}
              isChecked={isAgent}
              onPress={() => {
                if (isAgent) setIsAgent(false);
            ...
            <TextInput
              inputProps={{
                placeholder: getString("Phone Number Two"),
                value: phoneNumberTwo,
                onChangeText: setPhoneNumberTwo,
              }}
            />
            <Separator height={16} />
            <TextInput
