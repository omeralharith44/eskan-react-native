...
export const PropertyDetailScreen = () => {
  ...
  images.unshift(model.externalImage);
  ...
  const onClickNav = () => {
    ...
    navigation.navigate(NavigationNames.AddRequestPropertyScreen, {
      model: { ...model },
    });
  };
  ...
  return (
    <>
      ...
      >
        ...
        <SectionHeader title={getString("Contact")} />
        <SimpleButton
          title={getString("Contact")}
          onPress={onClickNav}
